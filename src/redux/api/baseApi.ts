...
export const baseApi = createApi({
    ...
    tagTypes: ["Auth", "User", "Contact", "Dashboard", "Event", "Support", "UserProfile", "MyEvent", "Promotion", "PromotionStats", "OrganizerDashboard", "AdminStats", "EventAnalytics", "Notifications"],
    endpoints: () => ({}),
});
