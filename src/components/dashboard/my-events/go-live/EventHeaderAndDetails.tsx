...
export default function EventHeaderAndDetails() {
    ...
    // Loading state - with proper sized skeletons
    if (isLoading) {
        return (
            <div className="border-b border-border pb-8">
                ...
                {/* Info row with icons - smaller skeletons */}
                <div className="flex items-center gap-4 mb-4 flex-wrap">
    ...
    return (
        <div className="pb-8">
            ...
            <div className="flex items-center gap-4 mb-4 flex-wrap">
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    <MapPin className="w-4 h-4" />
                    <span>{eventData.address || "Convention Center, San Francisco"}</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    <Clock className="w-4 h-4" />
                    <span>{eventData.startTime || "09:00"}</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    <Calendar className="w-4 h-4" />
                    <span>
